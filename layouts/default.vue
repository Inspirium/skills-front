...
const navigation = [
  ...
  { name: 'Uputstva pružateljima obrazovanja', href: '/uputstva', current: false },
...
<template>
  <div class="">
    <Html class="h-full backtiles">
    <Body class="h-full" />
    </Html>
    <Disclosure as="nav" class="b" v-slot="{ open }">
      <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 sm:pt-1">
        <div class="relative flex items-center justify-between h-28">
          <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <!-- Mobile menu button-->
            <DisclosureButton class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
