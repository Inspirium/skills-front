...
<template>
  ...
  <div class="px-8 bg-gray-100 py-10">
    <div class="block text-gray-700 font-bold text-xl mb-2">
      <div class="text-3xl mb-3">Vrste vještine</div>
      ...
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Vrsta vještine</th>
