...
function createIt() {
  useApiFetch('/api/v1/clusters', {
    method: 'post',
    body: $jsonSerializer.serialize('clusters', data.value),
  }).then(() => {
    loadIt()
...
function deleteIt(id) {
  useApiFetch(`/api/v1/clusters/${id}`, {
    method: 'delete',
  }).then((data) => {
    loadIt()
    console.log(data)
      ...
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SKOMP</th>
