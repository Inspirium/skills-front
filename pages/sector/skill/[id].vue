  ...
  <div v-if="Object.keys(skill).length" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between sm:flex-row flex-col text-grey-700 sm:items-end items-start mt-6">
      <div class="relative flex sm:hidden cursor-pointer self-center group" @click="router.back()">
        ...
        <svg id="Layer_1" class="dropshadow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="270px" height="220px" viewBox="0 0 141.74 162.98" xml:space="preserve">
          ...
          />
          <path
            fill-rule="evenodd" clip-rule="evenodd" fill="#333" d="M141.74,40.62L71.21,0L0,40.87v81.49l71.21,40.62l70.53-40.86
    ...
    <div v-if="true" class="flex sm:flex-row flex-col relative mt-2 sm:mt-12 mb-20">
        ...
        <div class="text-grey-700 font-dosis sm:ml-10 text-center sm:text-left">
          ...
          <template v-if="skill.programs.length">
            ...
            <ul class="font-roboto flex flex-col sm:items-start items-center space-y-4 text-lg list-disc sm:list-outside list-inside">
              <li v-for="item in skill.programs" class="text-gray-500">
      ...
      <div class="shrink-1 grow-0 sm:w-[280px] sm:ml-16 mt-10 sm:mt-0 mb-10 text-center sm:text-left">
        ...
        <svg
          id="Layer_1" class="hexoccupation bounce-reverse hidden sm:block" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          width="960px" height="1120px" viewBox="0 0 141.74 162.98" xml:space="preserve"
        >
          <polygon
            fill-rule="evenodd" clip-rule="evenodd" fill="#e5e0d8" class="text-grey-700 transition duration-500" points="141.74,40.62 71.21,0 0,40.87 0,122.36 71.21,162.98
          141.74,122.12 "
          />
        </svg>
      </div>
