...
<template>
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    ...
    <div class="flex mt-12">
      <div @click="router.push('/')" class="relative flex cursor-pointer">
        <h3 class="z-10 w-3/5 absolute text-center hex-text-center font-roboto font-medium text-2xl leading-8 transition text-grey-700 flex flex-col items-center justify-center">{{ sectors.name }}
