...
import { faArrowLeftLong, faArrowRightArrowLeft, faAtom, faBasketShopping, faBedPulse, faBook, faBuilding, faBuildingColumns, faCar, faChalkboardUser, faChild, faChurch, faComment, faDesktop, faGear, faMasksTheater, faPhotoFilm, faRocket, faSatelliteDish, faShield, faShip, faShirt, faTractor, faTree, faUmbrellaBeach, faUserSecret, faUserShield, faVial } from '@fortawesome/free-solid-svg-icons'
// import '@fortawesome/fontawesome-svg-core/styles.css'
export default defineNuxtPlugin((nuxtApp) => {
  // add icons to library
  library.add(faArrowLeftLong, faArrowRightArrowLeft, faTree, faUserSecret, faTractor, faVial, faShirt, faPhotoFilm, faShip, faDesktop, faBuilding, faBasketShopping, faUmbrellaBeach, faBedPulse, faMasksTheater, faAtom, faGear, faRocket, faChild, faChalkboardUser, faChurch, faBuildingColumns, faUserShield, faComment, faSatelliteDish, faCar, faShield, faBook)
